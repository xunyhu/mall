                ...
                <div className={styles.productList}>
                    {
                        data.map(item => {
                            ...
                            return <div className={styles.productItem} key={actProductId}>
                                <div className={styles.imageBox}>
                                    <img src={`${background}?x-oss-process=image/resize,w_900,limit_1`} alt="" />
                                </div>
                                <div className={styles.productName}>{}</div>
                                <div className={styles.productPrice}>
                                    <div className={styles.productPriceInner}>
                                        <div className={styles.priceText}><span>￥</span>{salePrice}</div>
