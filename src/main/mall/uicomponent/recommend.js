            ...
            <div className={styles.recommend}>
                ...
                <div className={styles.floor}>
                    <div className={styles.list}>
                        {
                            data.map(item => {
                                const { commission, masterImg, spuId, sales, name, mallPrice } = item
                                return <div className={styles.itemWrap} key={spuId}>
                                    <div className={styles.item}>
                                        <div className={styles.goodsWrap}>
                                            <div className={styles.imgBox}>
                                                <img src={`${masterImg}?x-oss-process=image/resize,w_168,limit_1`} alt=' ' />
                                            </div>
                                            <div className={styles.name}>{name}</div>
                                            <div className={styles.blockcenter}>
                                                <div className={styles.priceText}><span>￥</span>{mallPrice}</div>
                                                <div>
